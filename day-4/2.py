...
def make_move(quantity, starting_block, ending_block):
    list_to_move = starting_positions[starting_block - 1][-quantity:]
    starting_positions[starting_block - 1] = starting_positions[starting_block - 1][0:len(starting_positions[starting_block - 1]) - quantity]
    starting_positions[ending_block - 1].extend(list_to_move)
