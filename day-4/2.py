...
def is_overlap(e1_start, e1_end, e2_start, e2_end):
    if e1_start >= e2_start and e1_start <= e2_end:
        return True
    if e1_end <= e2_end and e1_end >= e2_start:
        return True
    return False
...
if __name__ == "__main__":
    ...
    for line in lines:
        ...
        if is_overlap(e1_start, e1_end, e2_start, e2_end) or is_overlap(e2_start, e2_end, e1_start, e1_end):
